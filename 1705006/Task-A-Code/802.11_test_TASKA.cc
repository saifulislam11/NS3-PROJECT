...
RoutingExperiment::CommandSetup (int argc, char **argv)
{
  ...
  cmd.AddValue ("m_CoverageArea", "One side of the coverage area where the nodes are scattered", m_CoverageArea);
...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  cvg << "ns3::UniformRandomVariable[Min=0.0|Max="<<m_CoverageArea*m_txRange<<"]";
  ...
  for (int i = 0; i < m_nSinks; i++)
    {
      ...
      temp.Start (Seconds (var->GetValue (18.0,19.0)));
